...
begin
  ...
  result.items.each do |ge|
    # print e.summary + "\n"
    next if ge.end.date.blank? or (ge.end.date < Date.today) # next if Date.parse(ge.start.date) < Date.today # # skip old events because they are not even in the all_events array
...
begin
  ...
  result.items.each do |ge|
    # print e.summary + "\n"
    ge.end.date.blank? or (ge.end.date < Date.today) # next if Date.parse(ge.start.date) < Date.today # # skip old events because they are not even in the all_events array
